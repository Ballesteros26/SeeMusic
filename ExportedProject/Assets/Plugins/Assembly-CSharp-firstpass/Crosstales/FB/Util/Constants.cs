...
namespace Crosstales.FB.Util
{
	public abstract class Constants : BaseConstants
	{
		...
		public const string ASSET_VERSION = "2022.1.3";

		public const int ASSET_BUILD = 20220622;
		...
		public new const string ASSET_3P_RTFB = "https://assetstore.unity.com/packages/slug/113006?aid=1011lNGT";
