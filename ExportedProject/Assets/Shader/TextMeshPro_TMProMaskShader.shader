Shader "TextMeshPro/TMProMaskShader" {
	Properties {
		...
		[PerRendererData] _OutlineColor ("Outline Color", Vector) = (0,0,0,1)
		_OutlineTex ("Outline Texture", 2D) = "white" {}
		_OutlineUVSpeedX ("Outline UV Speed X", Range(-5, 5)) = 0
		_OutlineUVSpeedY ("Outline UV Speed Y", Range(-5, 5)) = 0
		[PerRendererData] _OutlineWidth ("Outline Thickness", Range(0, 1)) = 0
