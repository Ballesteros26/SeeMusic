namespace System.Linq.Expressions
{
	internal static class Strings
	{
		...
		internal static string ArgCntMustBeGreaterThanNameCnt => null;

		internal static string BindingCannotBeNull => null;

		internal static string ArgumentTypeCannotBeVoid => null;
		...
		internal static string ArgumentMustBeFieldInfoOrPropertyInfoOrMethod => null;

		internal static string ArgumentMustBeInstanceMember => null;
		...
		internal static string IncorrectNumberOfMembersForGivenConstructor => null;

		internal static string IncorrectNumberOfArgumentsForMembers => null;

		internal static string LambdaTypeMustBeDerivedFromSystemDelegate => null;

		internal static string IncorrectNumberOfTypeArgsForFunc => null;

		internal static string IncorrectNumberOfTypeArgsForAction => null;
		...
		internal static string NonStaticConstructorRequired => null;
