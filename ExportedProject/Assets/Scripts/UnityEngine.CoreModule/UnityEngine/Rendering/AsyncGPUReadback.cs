...
namespace UnityEngine.Rendering
{
	...
	public static class AsyncGPUReadback
	{
		...
		private unsafe static void Request_Internal_Texture_1_Injected(Texture src, int mipIndex, AsyncRequestNativeArrayData* data, out AsyncGPUReadbackRequest ret)
		{
