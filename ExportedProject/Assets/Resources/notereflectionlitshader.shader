Shader "Custom/NoteReflectionLitShader" {
	Properties {
		_WorkflowMode ("WorkflowMode", Float) = 1
		_BaseMap ("Albedo", 2D) = "white" {}
		_BaseColor ("Color", Vector) = (1,1,1,1)
		_IndividualColor ("IndividualColor", Vector) = (1,1,1,1)
		_IsBlackKey ("IsBlackKey", Float) = 0
		_UVScaleOffset ("Scale", Vector) = (1,1,0,0)
		...
		_QueueOffset ("Queue offset", Float) = 3
